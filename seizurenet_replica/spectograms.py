...
def main():
    parser = argparse.ArgumentParser(description='Generate Saliency map S1 from feature map FT')
    ...
    save_data_dir = os.path.join(args.save_data_dir,tuh_eeg_szr_ver,'saliencyOne')
